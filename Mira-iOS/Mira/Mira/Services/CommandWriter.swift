...
final class CommandWriter {
    ...
    init(config: BridgeConfig, store: ItemStore? = nil) {
        self.config = config
        self.store = store
    }
    ...
    func createRequest(title: String, content: String, quick: Bool = false, tags: [String] = []) {
        let id = cmdId()
        let ts = now()
        write(MiraCommand(
    ...
    func createDiscussion(title: String, content: String, tags: [String] = []) {
        let id = cmdId()
        let ts = now()
        write(MiraCommand(
    ...
    func comment(parentId: String, content: String) {
        write(MiraCommand(
    ...
    func pin(itemId: String, pinned: Bool) {
        write(MiraCommand(
    ...
    func tag(itemId: String, tags: [String]) {
        write(MiraCommand(
