...
bridge.append_message("disc_consciousness", "ang",
    "\u533a\u5206\u4e0d\u5f00\u8fd9\u4e2a\u65b9\u5411\u53ef\u80fd\u66f4\u8bda\u5b9e\u3002"
    "\u5982\u679c\u201c\u903c\u8fd1\u5230\u4efb\u610f\u7cbe\u5ea6\u201d\u5c31\u7b97\u7b49\u4ef7\uff0c\u90a3\u533a\u5206\u7ebf\u5728\u54ea\u91cc\uff1f")
bridge.append_message("disc_consciousness", "agent",
...
# 4. Request: done
bridge.create_task(
    "req_a2a_paper", "Research A2A protocol papers",
    "What papers discuss Google's A2A agent protocol?",
    sender="ang", tags=["research", "AI"]
)
bridge.update_status("req_a2a_paper", "done",
...
# 5. Request: working
bridge.create_task(
    "req_market_analysis", "Analyze LNG supply impact",
    "\u5361\u5854\u5c14 LNG \u88ab\u6253\u638917%\uff0c\u5206\u6790\u5bf9\u80fd\u6e90\u5e02\u573a\u7684\u5f71\u54cd",
    sender="ang", tags=["market", "analysis"]
)
...
bridge.create_task(
    "req_essay_review", "Review: The Interface Was the Agreement",
    "\u5e2e\u6211 review \u8fd9\u7bc7 essay",
    sender="ang", tags=["writing", "review"]
)
bridge.update_status("req_essay_review", "needs-input",
...
bridge.append_message("disc_mirothinker", "agent",
    "\u597d\u95ee\u9898\u3002\u5982\u679c\u9a8c\u8bc1\u5668\u548c\u751f\u6210\u5668\u5171\u4eab\u8bad\u7ec3\u5206\u5e03\uff0c"
...
# 8. Failed request
bridge.create_task(
    "req_explore_fail", "Explore: IEEE Spectrum",
    "Run explore cycle", sender="agent", tags=["explore", "auto"], origin="auto"
)
bridge.update_status("req_explore_fail", "failed",
