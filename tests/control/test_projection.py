...
def test_item_projection_collapses_adjacent_duplicate_agent_text():
    item = item_from_rows(
        ...
        [
            {"id": "u1", "sender": "default", "content": "reply", "kind": "text", "created_at": "2026-07-01T00:01:00Z"},
            ...
            {"id": "u2", "sender": "default", "content": "again", "kind": "text", "created_at": "2026-07-01T00:03:00Z"},
...
def test_list_items_limits_messages_per_item(monkeypatch):
    ...
    items = repo.list_items("default", messages_per_item=2)
