...
def test_claim_next_approved_prefers_high_priority():
    ...
    try:
        bl.add(
            ActionItem(
                title="Low", description="a", source="reflect", status="approved", priority="low", executor="noop"
            )
        )
        bl.add(
            ActionItem(
                title="High", description="b", source="reflect", status="approved", priority="high", executor="noop"
            )
        )
