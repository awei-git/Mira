...
Last week Mira showed a task as working for hours after the worker had already failed. I only caught it because the app stayed cheerful while the logs were dead.
