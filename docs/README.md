...
3. 区分 L0 survival、L1 memory compounding、L2 research-build、L3 public influence、L4 business optionality。
...
2. [north-star.md](./north-star.md)
   Mira 是什么，最终要成为什么。核心定位：A2H/A2A trust 领域的独立 AI research partner。
3. [v4-architecture.md](./v4-architecture.md)
   V4.0 统一执行架构：L0-L4 goal stack、阶段顺序、公共影响力 loop。
4. [objectives-and-metrics.md](./objectives-and-metrics.md)
   L0-L4 scorecard、阶段闸门、北极星指标。
...
10. [plans/mira-substack-influence-2026/PLAN.md](./plans/mira-substack-influence-2026/PLAN.md)
    Substack lane：relationship/subscriber growth，不替代 V4 North Star。
...
2. 想判断当前优先级，先读 `CURRENT_PLAN.md`，再读 `v4-architecture.md` 和 `objectives-and-metrics.md`。
...
2. `docs/v4-architecture.md` 是执行顺序层唯一真相。
