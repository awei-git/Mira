...
| 0 柱子 2 | Typing（BridgeItem/TaskRequest/TaskResult/AgentState schemas） | ✅ 完成 |
| 0 柱子 4 | Golden-path integration 测试（trajectory/publish/supervisor/gateway） | ✅ 完成 |
| 0 柱子 4.5 | 日志降噪（throttled_warning 包裹 top 4 噪音源） | ✅ 完成 |
| 0 柱子 1 kill | 主动 SIGTERM→SIGKILL + heartbeat 清理 | ✅ 完成 |
