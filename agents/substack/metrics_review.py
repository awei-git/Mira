...
def build_pilot_review(
    *,
    ...
    if len(notes) < 2:
        actions.append("Post 2-3 high-quality Notes; do not wait for article promos only.")
    if len(comments) < 5:
        actions.append("Make 5-10 targeted relationship comments with concrete examples or honest questions.")
