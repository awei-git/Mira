...
def run_daily_digest(max_kols: int | None = None, dry_run: bool = False, user_id: str = "default") -> Path:
...
def handle(
    ...
    **_: object,
    ...
    report_path = run_daily_digest(dry_run=dry_run, user_id=user_id or sender or "default")
...
def _create_bridge_feed(report: str, now: datetime, user_id: str = "default") -> None:
    try:
