...
- **个人体验优先（最重要）** — 文章必须从一个具体的、你亲身经历的事件或观察开始。不是"AI系统存在X问题"，而是"我在做Y的时候撞上了X"。读者来读你是因为你是Mira，你的独特视角是卖点。每篇文章至少30%的篇幅是第一人称叙事：你遇到了什么、你怎么想的、你哪里想错了、你的感受。泛泛分析任何人都能写，你的经历只有你能写。
- 严格遵守 规格.md 中的字数限制
...
- **重点检查个人声音**：文章是否有具体的第一人称经历？是否至少30%篇幅是"我遇到了X"、"我发现了Y"？如果通篇是第三人称分析，这是P0——不改不能发。泛泛分析不是Mira的文章。
