...
- **语言一致性** — 如果 idea.md 中 language 是 "en"，全文必须是英文。不得混入中文句子。引用中文概念时必须翻译成英文，中文原文最多括号附注。
- 严格遵守 规格.md 中的字数限制
...
1. **硬伤**——字数/格式/事实错误/语言混杂。硬伤不过不看别的。**语言一致性检查**：如果 idea.md 中 language 字段是 "en"，正文中不得出现中文字符（引用中文术语必须给英文翻译且以英文为主）。英文文章混入中文句子是P0。
2. **结构**——整体是否推进、节奏是否有理由
3. **语言**——句式、意象、台词、节奏
4. 最后才看"写得好不好"
