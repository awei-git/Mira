...
class HealthStore:
    ...
    def insert_metric(self, person_id: str, metric_type: str, value: float,
    ...
    def get_recent_metrics(self, person_id: str, metric_type: str,
    ...
    def get_all_metric_types(self, person_id: str) -> list[str]:
        ...
        with self.conn.cursor() as cur:
            cur.execute(
                ...
                "WHERE person_id=%s ORDER BY metric_type",
                (person_id,)
            )
    ...
    def insert_note(self, person_id: str, category: str, content: str,
        ...
        with self.conn.cursor() as cur:
            cur.execute(
                "INSERT INTO health_notes (person_id, note_date, category, content) "
                "VALUES (%s, %s, %s, %s)",
    ...
    def insert_report(self, person_id: str, report_date: date,
                      parsed_json: dict, summary: str = "",
        ...
        with self.conn.cursor() as cur:
            cur.execute(
                ...
                (person_id, report_date, report_type, source_file,
                 json.dumps(parsed_json, ensure_ascii=False), summary)
            )
