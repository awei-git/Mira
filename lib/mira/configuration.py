...
def default_v3_config() -> V3Config:
    models = [
        ModelAssignment("orchestrator", "claude-opus-4-7", 64000),
        ModelAssignment("writer", "claude-sonnet-4-6", 128000),
        ModelAssignment("explorer", "claude-sonnet-4-6", 64000),
        ModelAssignment("analyst", "claude-sonnet-4-6", 64000),
        ModelAssignment("researcher", "claude-opus-4-7", 128000),
        ModelAssignment("coder", "codex", 128000),
        ModelAssignment("social", "claude-sonnet-4-6", 32000),
